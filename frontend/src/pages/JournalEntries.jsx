...
import { Calendar, CheckCircle, Edit, Eye, Filter, Plus, Search, Trash2, XCircle } from 'lucide-react';
import { useState } from 'react';
import toast from 'react-hot-toast';
import JournalEntryForm from '../components/Forms/JournalEntryForm';
import Modal from '../components/UI/Modal';
import { useLanguage } from '../contexts/LanguageContext';
import { useCreateJournalEntry, useJournalEntries, usePostJournalEntry } from '../hooks/useApi';
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 mb-4">Error loading journal entries: {error.message}</p>
                ...
                entries.map((entry) => {
                  ...
                  return (
                    <tr key={entry.id} className="hover:bg-gray-50 dark:hover:bg-gray-700">
                      ...
                      <td className="table-cell">
                        <span className={`badge ${getStatusColor(entry.is_posted)} flex items-center`}>
...
const EntryDetailsView = ({ entry, onClose }) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="border-b border-gray-200 pb-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-lg font-semibold text-gray-900">{entry.entry_number}</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="text-sm text-gray-900">{formatDate(entry.entry_date)}</p>
          </div>
          <div>
            <h3 className="text-sm font-medium text-gray-500">Reference</h3>
            <p className="text-sm text-gray-900">{entry.reference_number || '-'}</p>
          </div>
        </div>
        <div className="mt-4">
      ...
      {/* Entry Lines */}
      <div>
        <h3 className="text-lg font-medium text-gray-900 mb-4">Journal Entry Lines</h3>
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tfoot className="bg-gray-50">
              <tr>
                <td colSpan="2" className="px-4 py-3 text-sm font-medium text-right">
                  Totals:
                </td>
