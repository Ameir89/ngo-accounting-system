...
const JournalEntryForm = ({ onSubmit, onCancel, loading, editData = null }) => {
  ...
  const defaultValues = useMemo(
    () => ({
      entry_date:
        editData?.entry_date || new Date().toISOString().split("T")[0],
  ...
  const handleLineAmountChange = useCallback(
    (index, field, value) => {
      ...
      const oppositeField =
        field === "debit_amount" ? "credit_amount" : "debit_amount";
      if (numValue > 0) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                className={`form-input ${
                  errors.entry_date ? "border-red-300" : ""
                }`}
            ...
            <div>
              ...
              <input
                ...
                {...register(
                  "reference_number",
                  validationRules.reference_number
                )}
                className={`form-input ${
                  errors.reference_number ? "border-red-300" : ""
                }`}
            ...
            <div>
              ...
              <input
                ...
                className={`form-input ${
                  errors.exchange_rate ? "border-red-300" : ""
                }`}
              />
                  ...
                  >
                    <td className="px-4 py-3">
                      <AccountSelector
                        ...
                        onChange={(value) =>
                          setValue(`lines.${index}.account_id`, value)
                        }
                        accounts={accounts}
                    ...
                    <td className="px-4 py-3">
                      <AmountInput
                        ...
                        onChange={(value) =>
                          handleLineAmountChange(index, "debit_amount", value)
                        }
                        placeholder="0.00"
                        type="debit"
                        disabled={loading || isSubmitting}
                    ...
                    <td className="px-4 py-3">
                      <AmountInput
                        ...
                        onChange={(value) =>
                          handleLineAmountChange(index, "credit_amount", value)
                        }
                        placeholder="0.00"
                        type="credit"
                        disabled={loading || isSubmitting}
          ...
          <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-4">
            <div className="flex items-start">
              ...
              <div className="text-sm text-red-600 dark:text-red-400">
                {balanceError && (
                  <p className="mb-2">
                    The journal entry must be balanced. Total debits must equal
                    total credits.
                  </p>
                )}
                {errors.lines && (
                  <p>
                    Please ensure all lines have valid accounts and amounts.
                  </p>
                )}
              </div>
            </div>
